...
# Setup
You are in a disposable git worktree of $REPO, at a detached HEAD on the default branch with clean tracked content.
A pooled worktree may retain ignored local state; inspect any lease warning before attributing failures to this task.
