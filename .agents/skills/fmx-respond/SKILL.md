...
Those posts are firstmate's job on the task's milestone and completion wakes; see the `x-mode` skill for the full completion follow-up contract. This skill's only follow-up responsibility is linking the task in step 2c.
