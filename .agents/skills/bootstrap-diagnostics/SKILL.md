...
- `SECONDMATE_LIVENESS: secondmate <id>: skipped: <reason>|respawn failed[ after <cause>]: <reason>` - the session-start liveness sweep could not guarantee that a live secondmate's recorded endpoint is running a real agent process.
