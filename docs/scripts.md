...
| `fm-archive-task.sh`     | Copy a landed ship task's artifact directory into the product-local archive and the best-effort backup mirror before teardown removes the worktree |
