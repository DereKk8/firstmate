...
While supervision is still needed and `state/.afk` is absent (neither away nor quiet mode), an actionable close wakes the idle session through exit 2.
...
[`verification/supervision.md`](verification/supervision.md#watcher-continuity) records the current six-harness live evidence, including the 2026-09-05 omp run, the 2026-07-24 Stop-owned Claude auto-arm results, and exact opt-in commands.
