...
[`verification/supervision.md`](verification/supervision.md#watcher-continuity) records the current cross-harness live evidence, including the 2026-09-05 omp run, the dated Stop-owned Claude auto-arm results, and exact opt-in commands.
