...
The cross-harness evidence combines the 2026-07-17 live pass, Claude's replacement Stop-owned path revalidated on 2026-09-21, and the omp primary path verified on 2026-09-05, all against isolated project and home state.
