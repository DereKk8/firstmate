...
- **A visible crew** - every crewmate works in its own tmux window, experimental herdr/zellij/cmux tab, or Orca terminal you can watch or type into; the first mate reconciles.
...
```
 ...
 └──┬──────────────┬───────────────┬───┘
    ...
    ▼              ▼               ▼
 ┌────────┐   ┌────────┐      ┌────────┐
 │fm-task1│   │fm-task2│  ... │fm-taskN│   tmux windows, herdr/zellij/cmux tabs, or Orca terminals
